# completely original code and logic, with snippets from Beau
def arithmetic_arranger(problems, display=False):
    ...
    for problem in range(len(problems)):
        if len(problems[problem][0]) < len(problems[problem][1]):
            ...
            len_diffs.append(
                1 + (len(problems[problem][1])-len(problems[problem][0])))
        else:
            longest_operands.append("-1")

            len_diffs.append(-1 -
                             (len(problems[problem][0])-len(problems[problem][1])))
    ...
    if display == True:
        ...
        for problem in range(len(problems)):
            if operators[problem] == "+":
                solutions.append(
                    int(problems[problem][0]) + int(problems[problem][1]))
            else:
                solutions.append(
                    int(problems[problem][0]) - int(problems[problem][1]))
        ...
        for problem in range(len(problems)):
            if len(problems[problem][0]) > len(problems[problem][1]):
                num_spaces.append(
                    len(str(problems[problem][0])) - len(str(solutions[problem])))
            else:
                num_spaces.append(
                    len(str(problems[problem][1])) - len(str(solutions[problem])))
